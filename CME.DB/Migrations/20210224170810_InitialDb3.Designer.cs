...
namespace CME.DB.Migrations
{
    ...
    [Migration("20210224170810_InitialDb3")]
            ...
            modelBuilder.Entity("CME.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "BVXP",
                            CreatedOnDate = new DateTime(2021, 2, 25, 0, 8, 9, 389, DateTimeKind.Local).AddTicks(1885),
                            LastModifiedOnDate = new DateTime(2021, 2, 25, 0, 8, 9, 390, DateTimeKind.Local).AddTicks(3797),
                            Name = "BV Xanh Pôn"
                        });
                });
