...
namespace CME.DB.Migrations
{
    ...
    [Migration("20210224140141_IgnoreRequireUsername")]
    partial class IgnoreRequireUsername
    {
            ...
            modelBuilder.Entity("CME.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "BVXP",
                            CreatedOnDate = new DateTime(2021, 2, 24, 21, 1, 40, 382, DateTimeKind.Local).AddTicks(9256),
                            LastModifiedOnDate = new DateTime(2021, 2, 24, 21, 1, 40, 384, DateTimeKind.Local).AddTicks(1239),
