...
namespace CME.DB.Migrations
{
    ...
    [Migration("20210224171609_InitialDb5")]
            ...
            modelBuilder.Entity("CME.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "BVXP",
                            CreatedOnDate = new DateTime(2021, 2, 25, 0, 16, 8, 416, DateTimeKind.Local).AddTicks(7466),
                            LastModifiedOnDate = new DateTime(2021, 2, 25, 0, 16, 8, 418, DateTimeKind.Local).AddTicks(3332),
                            Name = "BV Xanh Pôn"
                        });
                });
