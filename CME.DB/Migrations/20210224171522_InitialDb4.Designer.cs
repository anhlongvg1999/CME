...
namespace CME.DB.Migrations
{
    ...
    [Migration("20210224171522_InitialDb4")]
            ...
            modelBuilder.Entity("CME.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "BVXP",
                            CreatedOnDate = new DateTime(2021, 2, 25, 0, 15, 21, 776, DateTimeKind.Local).AddTicks(7129),
                            LastModifiedOnDate = new DateTime(2021, 2, 25, 0, 15, 21, 777, DateTimeKind.Local).AddTicks(8495),
                            Name = "BV Xanh Pôn"
                        });
                });
