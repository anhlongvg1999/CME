    ...
    public partial class InitialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-2222-0000-0000-000000000001"), null, "admin", null, new DateTime(2021, 3, 10, 0, 8, 54, 556, DateTimeKind.Local).AddTicks(1619), null, new DateTime(2021, 3, 10, 0, 8, 54, 556, DateTimeKind.Local).AddTicks(1624), "Admin", null },
                    { new Guid("00000000-2222-0000-0000-000000000002"), null, "normal-user", null, new DateTime(2021, 3, 10, 0, 8, 54, 556, DateTimeKind.Local).AddTicks(1791), null, new DateTime(2021, 3, 10, 0, 8, 54, 556, DateTimeKind.Local).AddTicks(1794), "Người dùng", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), "12 Chu Văn An, Điện Bàn, Ba Đình, Hà Nội", null, "BVXP", null, new DateTime(2021, 3, 10, 0, 8, 54, 552, DateTimeKind.Local).AddTicks(9493), null, new DateTime(2021, 3, 10, 0, 8, 54, 554, DateTimeKind.Local).AddTicks(1119), "BV Xanh Pôn", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-200000000001"), null, "HTHN", null, new DateTime(2021, 3, 10, 0, 8, 54, 555, DateTimeKind.Local).AddTicks(6148), null, new DateTime(2021, 3, 10, 0, 8, 54, 555, DateTimeKind.Local).AddTicks(6157), "Hội thảo, hội nghị", null },
                    { new Guid("00000000-0000-0000-0000-200000000002"), null, "NCKH", null, new DateTime(2021, 3, 10, 0, 8, 54, 555, DateTimeKind.Local).AddTicks(9317), null, new DateTime(2021, 3, 10, 0, 8, 54, 555, DateTimeKind.Local).AddTicks(9320), "Nghiên cứu khoa học", null },
                    { new Guid("00000000-0000-0000-0000-200000000003"), null, "DTDH", null, new DateTime(2021, 3, 10, 0, 8, 54, 555, DateTimeKind.Local).AddTicks(9338), null, new DateTime(2021, 3, 10, 0, 8, 54, 555, DateTimeKind.Local).AddTicks(9340), "Đào tạo dài hạn", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("00000000-0000-0000-0000-300000000001"), 4.0, null, null, null, new DateTime(2021, 3, 10, 0, 8, 54, 555, DateTimeKind.Local).AddTicks(9097), null, new DateTime(2021, 3, 10, 0, 8, 54, 555, DateTimeKind.Local).AddTicks(9103), "Người tham dự", 0, null, new Guid("00000000-0000-0000-0000-200000000001") });

            migrationBuilder.InsertData(
                table: "cat_TrainingSubjects",
                columns: new[] { "Id", "Amount", "ApplicationId", "Code", "CreatedByUserId", "CreatedOnDate", "LastModifiedByUserId", "LastModifiedOnDate", "Name", "Order", "ParentId", "TrainingFormId" },
                values: new object[] { new Guid("00000000-0000-0000-0000-300000000002"), 8.0, null, null, null, new DateTime(2021, 3, 10, 0, 8, 54, 555, DateTimeKind.Local).AddTicks(9288), null, new DateTime(2021, 3, 10, 0, 8, 54, 555, DateTimeKind.Local).AddTicks(9290), "Người thuyết trình", 0, null, new Guid("00000000-0000-0000-0000-200000000001") });

            migrationBuilder.InsertData(
                table: "cat_TrainingSubjects",
                columns: new[] { "Id", "Amount", "ApplicationId", "Code", "CreatedByUserId", "CreatedOnDate", "LastModifiedByUserId", "LastModifiedOnDate", "Name", "Order", "ParentId", "TrainingFormId" },
                values: new object[] { new Guid("00000000-0000-0000-0000-330000000001"), 24.0, null, null, null, new DateTime(2021, 3, 10, 0, 8, 54, 555, DateTimeKind.Local).AddTicks(9364), null, new DateTime(2021, 3, 10, 0, 8, 54, 555, DateTimeKind.Local).AddTicks(9365), "NV nội vụ", 0, null, new Guid("00000000-0000-0000-0000-200000000003") });
